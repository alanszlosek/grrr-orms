...
class User extends \Norma\Norma
{
...
class File extends \Norma\Norma
{
...
class NoPK extends \Norma\Norma
{
...
class NonAutoPK extends \Norma\Norma
{
...
class Combo extends \Norma\Norma
{
...
class UniqueKey extends \Norma\Norma
{
...
class TestSetup extends PHPUnit_Framework_TestCase
{
    public static function setUpBeforeClass()
    {
        ...
        if (get_class($db) == 'dbFacile\\sqlite3') {
